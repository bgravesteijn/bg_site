...
This device, ECMO, can thus be used in patients whose hearts stopped, for example in patients who suffered from an in-hospital cardiac arrest. This is the group of patients where we did our analysis for. The question was specifically aimed to address the costs and effects in this group, because this group has a large potential for cost-effectiveness.
